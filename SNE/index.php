...
<head>
  <meta charset="utf-8">
  <title>Sistema de Calificaciones Web</title>
    ...
    <div class="row py-2 px-lg-5">
      <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
        <div class="d-inline-flex align-items-center text-white">
          <small><i class="fa fa-phone-alt mr-2"></i>0996796229</small>
          <small class="px-3">|</small>
          <small><i class="fa fa-envelope mr-2"></i>mateus05@hotmail.com</small>
        </div>
      </div>
        ...
        <div class="col-lg-5 mb-5 mb-lg-0">
          <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="mt-n1">
                <h4>Correo</h4>
                <p class="m-0">mateus05@hotmail.com</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container mt-5 pt-5">
      ...
      <div class="row">
        <div class="col-md-4 mb-5">
          ...
          <p><i class="fa fa-map-marker-alt mr-2"></i>Fernando Cárdenas</p>
          <p><i class="fa fa-phone-alt mr-2"></i>0996796229</p>
          <p><i class="fa fa-envelope mr-2"></i>mateus058@hotmail.com</p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
          <p class="m-0"><a class="text-white" href="#">Sistema de Notas</a>
          </p>
        </div>
      </div>
    </div>
